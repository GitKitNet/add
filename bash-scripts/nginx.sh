...
# Version: 1.5.0
# Date: 2022-05-27
# Author: Git Kit Net <gitkitnet@gmail.com>
# Description: Easy Engine NGiNX konfiguration.
#
#------------------------------------------------------------------------------------
...
version="1.5.0"
date="2022-05-27"
UserName="Git Kit Net"
email="gitkitnet@gmail.com"
...
#------------------------------------------------------------------------------------
if [ "$(id -u)" != "0" ]; then
    echo -en "\n\t\t ${RED}Error: ${NC} \n ${YELLOW}You must be root to run this script, please use the root user to install the software. ${NC}"
    sleep 5
  # exit 1
fi;
clear
