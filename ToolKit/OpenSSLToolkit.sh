...
#  bash <(curl -fSsL raw.githubusercontent.com/numbnet/WebPanel/master/bash-scripts/ssl/OpenSSLToolkit.sh || wget -O - raw.githubusercontent.com/numbnet/WebPanel/master/bash-scripts/ssl/OpenSSLToolkit.sh)

title="OpenSSL Tool Kit"
