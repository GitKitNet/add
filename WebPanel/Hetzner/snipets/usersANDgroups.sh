...
# The following example adds the ubuntu group with members 'root' and 'sys' and the empty group cloud-users.
...
# Note: Most of these configuration options will not be honored if the user already exists. Following options are the exceptions and they are applicable on already-existing users:
