...
yum -y install gcc gcc-c++ make automake autoconf rsync nano links e2fsprogs rsyslog net-tools man mlocate which screen sysstat
...
wget static.cdn-cwp.com/files/cwp/el7/cwp-el7-0.9.8.1078.zip
unzip -o -q cwp-el7-0.9.8.1078.zip
rm -f cwp-el7-0.9.8.1078.zip
