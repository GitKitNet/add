...
# Because the data directory can be huge or on
# external storage, an automatic chmod/chown can take a while.
# Therefore this directory can be treated differently.
# If you have already created an external "data" and 
# "apps-external" directory which you want to link,
# set the paths above accordingly. This script can link and
# set the proper rights and permissions
# depending what you enter when running the script.

# When the instance is setup either post a fresh install or
# after an upgrade, run this script again but
# only for securing ".htaccess files". This sets the
# appropriate ownership and permission for them.

# In case you upgrade an existing installation,
# your original directory will be renamed including a timestamp
...
# should see a success message. Now,
# enter the URL of your ownCloud instance
# in a browser and continue the setup via
# the graphical installation wizard. For
# more information, see The Installation Wizard.
# If you installed locally, depending on
# your webserver setup, you should be able
# to access your ownCloud instance via a browser
# at https://127.0.0.1/owncloud/ or localhost/owncloud/.
